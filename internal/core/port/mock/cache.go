...
func (mr *MockCacheRepositoryMockRecorder) DeleteByPrefix(ctx, prefix interface{}) *gomock.Call {
	mr.mock.ctrl.T.Helper()
...
func (mr *MockCacheRepositoryMockRecorder) Set(ctx, key, value, ttl interface{}) *gomock.Call {
	mr.mock.ctrl.T.Helper()
